    ...
    <section id="secao">
        <div id="formulario">
            <div id="divFormulario" class="">
                <form data-parsley-validate id="form" class="mb-3" action="./criarConta/criarConta.php" method="POST">
                    ...
                    if (isset($_GET["erro"])) {
                        ...
                        <div class='alert alert-danger' role='alert'>
                            Usuário ou e-mail ou senha incorretos, por favor tente novamente ou tente se cadastrar!
                        </div>";
                    }
                    ?>   

                    <div class="form-floating mt-4">
                        <input type="email" class="form-control" name="nome" id="InputEmail" required>
                        <label for="InputEmail">Nome <span style="color: red">*</span></label>
                    </div> 
