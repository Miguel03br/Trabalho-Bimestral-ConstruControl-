    ...
    <section id="secao">
        <div id="formulario">
            <div id="divFormulario" class="">
                <form data-parsley-validate id="form" class="mb-3" action="verificarLogin.php" method="POST">
                    ...
                    if (isset($_GET["erro"])) {
                        ...
                        <div class='alert alert-danger' role='alert'>
                            E-mail ou senha incorretos, por favor tente novamente ou tente se cadastrar!
                        </div>";
                    }
                    ?>                
