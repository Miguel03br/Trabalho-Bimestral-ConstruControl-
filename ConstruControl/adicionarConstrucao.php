...
<section id="secao">
            ...
            <div id="divFormulario" class="">
                <form data-parsley-validate id="form" class="mb-3" action="" method="POST"> 
                    ...
                    <div class="form-floating mt-3">
                        ...
                        <input type="email" class="form-control" name="nomeConstrucao" id="InputEmail" required>
                    </div>

                    <div class="form-floating mt-3">
                        <p>Data Final: <span style="color: red">*</span></p>
                        <input type="password" class="form-control" name="dataFinal" id="InputSenha" required>
                    </div>

                    <div class="input-group">
                        <p>Andamento: <span style="color: red">*</span></p>
                        <select class="form-select" name="processoAndamento" id="inputGroupSelect04" aria-label="Example select with button addon">
                    ...
                    <div class="form-floating mt-3">
                        ...
                        <input type="password" class="form-control" name="solicitacoes" id="InputSenha" required>
                    </div>
    ...
    <?php
        if(isset($_POST["Enviar"])){
            header("location: ./criarTabela/criarTabela.php");
        }
    ?>
</body>
